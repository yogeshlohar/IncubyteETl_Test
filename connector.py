...
df = pd.read_sql('SELECT * from Cust_info', con=database)  # fitting into pandas dataframe
...
def get_file(country):
    ...
    data.to_csv('C:/Users/Yogi/downloads/' + country + ".csv")  # replace path with your desired path
